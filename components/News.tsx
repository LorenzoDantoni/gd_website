    ...
    <section className="bg-gray-50 py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 text-center">
          <Link
            href="/news-eventi"
            className="inline-block rounded-full border border-orange-500 px-8 py-3 text-lg font-semibold text-orange-500 transition-colors duration-300 hover:bg-orange-500 hover:text-white focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2"
          >
            Vedi tutte le news
          </Link>
        </div>
