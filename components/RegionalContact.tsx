  ...
  return (
    <div className="bg-white shadow-md overflow-hidden border border-gray-200 transform transition-transform duration-300 hover:scale-105">
      <div className="p-8 text-center">
        <h2 className="text-3xl font-bold text-gray-800 mb-4">{federation}</h2>
        <p className="text-lg text-gray-700 mb-2">{address}</p>
        <a href={`mailto:${email}`} className="text-orange-500 hover:text-orange-600 transition-colors duration-300 text-lg font-medium">{email}</a>
